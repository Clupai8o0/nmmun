...
Since we were rushing the clock, we decided to use the same website. And so much work was put into this website anyways do its obvious to carry it forward to the next batch. 💯
