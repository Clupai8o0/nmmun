		...
		<BaseLayout navbar={{ dark: true }}>
			...
			<Container id="payment" background={<Background color="bg-color-5" />}>
				<Details>
					...
					>
						NMS applicants are kindly requested to complete their application process 
						by filling out the Google Form. Additionally, it is essential to print 
						your google form response accompanied by a payment of 20 BHD, to their 
						respective HRT. Your adherence to this procedure ensures a seamless application process.
					</Paragraph>
